...
-- Dump completed on 2020-04-02 16:53:01

use guestbookdb;
INSERT INTO eintrag (titel,text,datum,FK_login) VALUES
('Eintrag 1 von Benutzer 1','Text 1 von Benutzer 1','2020-12-11',1),
('Eintrag 2 von Benutzer 1','Text 2 von Benutzer 1','2020-12-12',1),
('Eintrag 3 von Benutzer 1','Text 3 von Benutzer 1','2020-12-13',1),
('Eintrag 4 von Benutzer 1','Text 4 von Benutzer 1','2020-12-14',1),
('Eintrag 5 von Benutzer 1','Text 5 von Benutzer 1','2020-12-15',1),
('Eintrag 1 von Benutzer 2','Text 1 von Benutzer 2','2020-12-11',2),
('Eintrag 2 von Benutzer 2','Text 2 von Benutzer 2','2020-12-12',2),
('Eintrag 3 von Benutzer 2','Text 3 von Benutzer 2','2020-12-13',2),
('Eintrag 4 von Benutzer 2','Text 4 von Benutzer 2','2020-12-14',2),
('Eintrag 5 von Benutzer 2','Text 5 von Benutzer 2','2020-12-15',2),
('Eintrag 1 von Benutzer 3','Text 1 von Benutzer 3','2020-12-11',3),
('Eintrag 2 von Benutzer 3','Text 2 von Benutzer 3','2020-12-12',3),
('Eintrag 3 von Benutzer 3','Text 3 von Benutzer 3','2020-12-13',3),
('Eintrag 4 von Benutzer 3','Text 4 von Benutzer 3','2020-12-14',3),
('Eintrag 5 von Benutzer 3','Text 5 von Benutzer 3','2020-12-15',3),
('Eintrag 1 von Benutzer 4','Text 1 von Benutzer 4','2020-12-11',4),
('Eintrag 2 von Benutzer 4','Text 2 von Benutzer 4','2020-12-12',4),
('Eintrag 3 von Benutzer 4','Text 3 von Benutzer 4','2020-12-13',4),
('Eintrag 4 von Benutzer 4','Text 4 von Benutzer 4','2020-12-14',4),
('Eintrag 5 von Benutzer 4','Text 5 von Benutzer 4','2020-12-15',4),
('Eintrag 1 von Benutzer 5','Text 1 von Benutzer 5','2020-12-11',5),
('Eintrag 2 von Benutzer 5','Text 2 von Benutzer 5','2020-12-12',5),
('Eintrag 3 von Benutzer 5','Text 3 von Benutzer 5','2020-12-13',5),
('Eintrag 4 von Benutzer 5','Text 4 von Benutzer 5','2020-12-14',5),
('Eintrag 5 von Benutzer 5','Text 5 von Benutzer 5','2020-12-15',5),
('Eintrag 1 von Benutzer 6','Text 1 von Benutzer 6','2020-12-11',6),
('Eintrag 2 von Benutzer 6','Text 2 von Benutzer 6','2020-12-12',6),
('Eintrag 3 von Benutzer 6','Text 3 von Benutzer 6','2020-12-13',6),
('Eintrag 4 von Benutzer 6','Text 4 von Benutzer 6','2020-12-14',6),
('Eintrag 5 von Benutzer 6','Text 5 von Benutzer 6','2020-12-15',6),
('Eintrag 1 von Benutzer 7','Text 1 von Benutzer 7','2020-12-11',7),
('Eintrag 2 von Benutzer 7','Text 2 von Benutzer 7','2020-12-12',7),
('Eintrag 3 von Benutzer 7','Text 3 von Benutzer 7','2020-12-13',7),
('Eintrag 4 von Benutzer 7','Text 4 von Benutzer 7','2020-12-14',7),
('Eintrag 5 von Benutzer 7','Text 5 von Benutzer 7','2020-12-15',7),
('Eintrag 1 von Benutzer 8','Text 1 von Benutzer 8','2020-12-11',8),
('Eintrag 2 von Benutzer 8','Text 2 von Benutzer 8','2020-12-12',8),
('Eintrag 3 von Benutzer 8','Text 3 von Benutzer 8','2020-12-13',8),
('Eintrag 4 von Benutzer 8','Text 4 von Benutzer 8','2020-12-14',8),
('Eintrag 5 von Benutzer 8','Text 5 von Benutzer 8','2020-12-15',8),
('Eintrag 1 von Benutzer 9','Text 1 von Benutzer 9','2020-12-11',9),
('Eintrag 2 von Benutzer 9','Text 2 von Benutzer 9','2020-12-12',9),
('Eintrag 3 von Benutzer 9','Text 3 von Benutzer 9','2020-12-13',9),
('Eintrag 4 von Benutzer 9','Text 4 von Benutzer 9','2020-12-14',9),
('Eintrag 5 von Benutzer 9','Text 5 von Benutzer 9','2020-12-15',9),
('Eintrag 1 von Benutzer 10','Text 1 von Benutzer 10','2020-12-11',10),
('Eintrag 2 von Benutzer 10','Text 2 von Benutzer 10','2020-12-12',10),
('Eintrag 3 von Benutzer 10','Text 3 von Benutzer 10','2020-12-13',10),
('Eintrag 4 von Benutzer 10','Text 4 von Benutzer 10','2020-12-14',10),
('Eintrag 5 von Benutzer 10','Text 5 von Benutzer 10','2020-12-15',10);

SELECT COUNT(*) FROM eintrag;

SELECT nachname, vorname, email, password
FROM benutzer t1
INNER JOIN login t2
ON t1.FK_Login = t2.id;

SELECT t1.nachname, t1.vorname, t2.email, t2.password
FROM benutzer t1
INNER JOIN login t2
ON t1.FK_Login = t2.id;

SELECT t1.id, t1.email, t2.nachname, t2.vorname
FROM login t1
INNER JOIN benutzer t2
ON t1.id = t2.FK_Login;

SELECT t1.email, t2.nachname, t2.vorname
FROM login t1
INNER JOIN benutzer t2
ON t1.id = t2.FK_Login
WHERE t1.email like '%purus%';

SELECT t1.email, t2.nachname, t2.vorname
FROM login t1
INNER JOIN benutzer t2
ON t1.id = t2.FK_Login
WHERE t2.land = 'Isle of Man' OR t2.land = 'Malaysia';

SELECT t1.titel, t1.text, t1.datum, t2.email, t3.vorname, t3.nachname
FROM eintrag t1
INNER JOIN login t2
ON t1.FK_Login = t2.id
INNER JOIN benutzer t3
ON t2.id = t3.FK_Login;