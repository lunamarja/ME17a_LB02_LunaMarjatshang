...
SELECT DISTINCT land FROM benutzer;
SELECT DISTINCT land FROM benutzer ORDER BY land DESC;
...
SELECT nachname, vorname, telefon FROM benutzer WHERE telefon like '%67%';
SELECT nachname, vorname, telefon FROM benutzer WHERE telefon like '_02%';